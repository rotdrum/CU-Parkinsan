...
<head>
    ...
    <script>
        var vel_exercise = {{ $exercise->ex_clasp_l }} ;
    </script>
    @endforeach
            ...
            if (hand){
                ...
                if(dot <= vel_exercise){
                    Swal.fire({
                        ...
                        html: 'คลิกเพื่อทำแบบทดสอบท่าต่อไป :)<br/><form method="POST" action="{{ route("updateboxmode3") }}" >@csrf<input type="hidden" name="id" id="id_ex"><br/><input type="hidden" name="value_" id="vels"><br/><input type="submit" value="Next" class="btn btn-primary"></form>',
                    })
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <div  class="nav-link" style="color:#fff;"><h4>คำสั่ง : กำมือซ้าย</h4></div>
                        </li>
                        <li class="nav-item">  
