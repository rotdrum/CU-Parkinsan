            ...
            if (hand){
                ...
                if(dot <= vel_exercise){
                    Swal.fire({
                        ...
                        html: 'คลิกเพื่อทำแบบทดสอบท่าต่อไป :)<br/><form method="POST" action="{{ route("updateboxmode2") }}" >@csrf<input type="hidden" name="id" id="id_ex"><br/><input type="hidden" name="value_" id="vels"><br/><input type="submit" value="Next" class="btn btn-primary"></form>',
                    })
