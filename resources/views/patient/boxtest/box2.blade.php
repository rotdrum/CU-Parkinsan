    ...
    .on('handFound', function(hand){
      ...
      hand.fingers.forEach(function (finger) {
        ...
        finger.bones.forEach(function(bone) {
          ...
          var boneMesh = new THREE.Mesh(
              new THREE.CylinderGeometry(16, 16, bone.length),
              new THREE.MeshPhongMaterial()
          );
  
          boneMesh.material.color.setHex(0xFDD7A0);
          scene.add(boneMesh);
        ...
        for (var i = 0; i < finger.bones.length + 1; i++) {
          ...
          jointMesh.material.color.setHex(0xFDCD8C);
          scene.add(jointMesh);
      ...
      if (hand.arm){ // 2.0.3+ have arm api,
        ...
        var armMesh = new THREE.Mesh(
          new THREE.CylinderGeometry(1.5, 1.5, hand.arm.length, 600),
          new THREE.MeshPhongMaterial()
        );
  
        armMesh.material.color.setHex(0xFDD7A0);
